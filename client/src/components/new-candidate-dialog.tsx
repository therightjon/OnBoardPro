...
import { AutoSelectCombobox } from "@/components/inputs/AutoSelectCombobox";
import { searchDepartments, searchDivisions, searchManagers } from "@/lib/search";
import type { Template, CandidateType, Department, Division, User as UserType, TemplateTask, TaskDefinition, HiringStage } from "@shared/schema";
...
export function NewCandidateDialog({ open, onOpenChange }: NewCandidateDialogProps) {
  ...
  const createCandidateMutation = useMutation({
    mutationFn: async (data: NewCandidateForm) => {
      ...
      if (!templateRes.ok) {
        // If template application fails, we should ideally delete the candidate
